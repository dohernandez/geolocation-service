...
COPY --from=builder --chown=dohernandez:dohernandez /go/src/github.com/dohernandez/geolocation-service/bin/cli-import-geolocation-service-data /bin/cli-import-geolocation-service-data
