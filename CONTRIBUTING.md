# Contributing to geolocation-service

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to `geolocation-service`.
...
We accept contributions via Pull Requests on [Github](https://github.com/dohernandez/geolocation-service).

## How Can I Contribute?

### Reporting Bugs

This section guides you through submitting a bug report for `geolocation-service`. Following these guidelines helps maintainers 
...
* **Describe the exact steps which reproduce the problem** in as many details as possible. For example, start by explaining how you started `geolocation-service`, 
...
* **Which version of `swiss-army-knife` are you using?**
